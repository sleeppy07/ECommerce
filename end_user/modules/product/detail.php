            ...
            <div class="row">
                    ...
                    <div class="product-gallery product-gallery-vertical">
                        <div class="row">
                            <figure class="product-main-image">
                                <img id="product-zoom" src="<?php echo $item['product_thumb'] ?>">
                ...
                <div class="col-md-6">
                    <div class="product-details">
                        <h1 class="product-title"><?php echo $item['product_name'] ?></h1><!-- End .product-title -->
                        ...
                        <div class="product-details-action">
                            <a href="<?php echo "?mod=cart&act=add&id={$id}" ?>" class="btn-product btn-cart"><span>add to cart</span></a>
                        ...
                        <div class="product-details-footer">
                            <div class="product-cat">
                                <span>Category:</span>
                                <a href=""> <?php echo get_product_cat_by_id($item['id_cat'])['cat_title'] ?></a>
                            </div><!-- End .product-cat -->
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="product-desc-tab" role="tabpanel" aria-labelledby="product-desc-link">
                    <div class="product-desc-content">
                        ...
                        <p><?php echo $item['product_information'] ?></p>
                        <!-- <ul>
